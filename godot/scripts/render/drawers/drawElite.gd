...
func drawElite(e) -> void:
	...
	if K == "cheer":
		...
		ctx.fill_style(dress)
		ctx.begin_path()
		ctx.round_rect(-R * 0.42, -R * 0.28, R * 0.84, R * 0.42, R * 0.12)
		ctx.fill()
		ctx.fill_style(trim)
		...
		ctx.begin_path()
		ctx.round_rect(-R * 0.5, 0, R * 1.0, R * 0.72, R * 0.14)
		ctx.fill()
		ctx.fill_style(skin)
		ctx.begin_path()
		...
		ctx.fill_style("#111")
		ctx.begin_path()
		ctx.round_rect(R * 0.42, R * 0.12, R * 0.15, R * 0.3, R * 0.04)
		ctx.fill()
	elif K == "voideye":
		...
		ctx.begin_path()
		ctx.arc(0, -R * 0.54, R * 0.38, PI, 0)
		ctx.fill()
		ctx.fill_style("#111")
		ctx.begin_path()
		ctx.round_rect(-R * 0.28, -R * 0.46, R * 0.56, R * 0.16, R * 0.05)
		ctx.fill()
		ctx.fill_style(tie)
