function drawLily(b, flash) {
  const R = b.r;
  const fur = flash ? '#fff' : '#f5f2ec',
    furSh = flash ? '#fff' : '#dcd6c9',
    pink = '#e8b8c0';
  ...
  const cg = ctx.createLinearGradient(-R * 0.5, 0, R * 0.5, 0);
  ...
  ctx.lineCap = 'round';
  ctx.beginPath();
  ctx.arc(0, R * 0.28, R * 0.52, Math.PI * 0.16, Math.PI * 0.84);
  ctx.stroke();
  ctx.fillStyle = '#14f195';
  circle(0, R * 0.55, R * 0.11, '#14f195');
  ...
  ctx.fill();
  ctx.fillStyle = '#fff';
  circle(-R * 0.28, -R * 0.17, R * 0.03, '#fff');
  circle(R * 0.22, -R * 0.17, R * 0.03, '#fff');
  // muzzle + black nose
  ctx.fillStyle = furSh;
  ctx.beginPath();
  ...
  ctx.fill();
  ctx.fillStyle = flash ? '#888' : '#141014';
  ctx.beginPath();
  ctx.ellipse(0, R * 0.02, R * 0.12, R * 0.09, 0, 0, 7);
  ctx.fill();
  ctx.fillStyle = 'rgba(255,255,255,0.5)';
  circle(-R * 0.03, -R * 0.01, R * 0.03, 'rgba(255,255,255,0.5)');
  // little frown mouth
  ...
  ctx.lineTo(0, R * 0.2);
  ctx.moveTo(0, R * 0.2);
  ctx.quadraticCurveTo(-R * 0.12, R * 0.28, -R * 0.2, R * 0.2);
  ctx.moveTo(0, R * 0.2);
  ctx.quadraticCurveTo(R * 0.12, R * 0.28, R * 0.2, R * 0.2);
  ctx.stroke();
